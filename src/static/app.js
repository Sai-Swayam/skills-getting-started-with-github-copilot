document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      console.log("Activities fetched:", activities); // Debugging log
      ...
      Object.entries(activities).forEach(([name, details]) => {
        console.log("Processing activity:", name, details); // Debugging log
      ...
      console.error("Error fetching activities:", error); // Debugging log
  ...
  signupForm.addEventListener("submit", async (event) => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            messageDiv.className = "success";
            signupForm.reset();
            fetchActivities(); // Refresh the activities list to show the updated participants
        } else {
            messageDiv.textContent = result.detail || "An error occurred";
            messageDiv.className = "error";
        }
